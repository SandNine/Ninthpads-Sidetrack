...
Mais primeiro, esse README está na sua linguagem certa?
...
## 📦 Atualizações, Apenas Executável, & Mais...
O Ninthpads, com seu método de compilação e estrutura de código-fonte, tem suas particularidades.  
Uma delas é que todos os arquivos essenciais `(.py)` _(Python)_ são incorporados dentro do arquivo executável `(.exe)`.
